...
async def suggest_new_posts(delete_bad_creators=True, manual_check=False, test_sleep=60, production_sleep=30): # delete_bad_creators behaviour should be checked on the same yt_authors (maybe they're bad only sometimes)
    while True:
